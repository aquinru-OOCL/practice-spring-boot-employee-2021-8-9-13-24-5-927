...
//        employees.add(new Employee("russel", 22, "male", 1000));
//        employees.add(new Employee("janley", 18, "male", 50000));
//        employees.add(new Employee("barbie", 20, "female", 2000));
...
//        // Given
//        Employee employee = new Employee("ace", 21, "male", 500);
...
//        // Given
//        Employee employee = new Employee("russel", 22, "male", 1000);
...
//        // Given
//        Employee employee = new Employee("russel", 22, "male", 9999);
...
//
//        // Then
//        assertNull(employeeService.findEmployeeById(employeeId));
//    }
//
//}
